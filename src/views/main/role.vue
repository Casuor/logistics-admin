<template>
  <div>
    ...
    <el-form :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" icon="el-icon-search" @click="searchItem(searchForm.roleName)">查找</el-button>
      </el-form-item>
      <el-form-item>
    ...
    <el-dialog title="新增角色" :visible.sync="dialogFormVisibleOfInsert" :before-close="handleClose">
      <el-form :model="searchForm" :rules="rules" ref="searchForm" label-width="100px">
        ...
        <el-form-item label="权限描述" prop="roleDescription">
          <el-input v-model="searchForm.roleDescription"></el-input>
        </el-form-item>
        <el-form-item label="角色状态" prop="roleStatus">
          <el-radio-group v-model="searchForm.roleStatus">
